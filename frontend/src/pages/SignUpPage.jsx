...
import { ShipWheelIcon, User } from "lucide-react";
    ...
    >
      ...
      >
            ...
            <form onSubmit={handleSignup}>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70"> Join Chattrix and enjoy your language learning adventure!</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="form-control w-full">
                    ...
                    <input type="text" placeholder="enter your fullname..." className="input input-bordered w-full"
                  ...
                  <div className="form-control w-full">
                    ...
                    <input type="email" placeholder="jhon@email.com" className="input input-bordered w-full"
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="mx-w-md p-8">
            {/* Illustration */}
            <div className="r ealtive aspect-square max-w-sm mx-auto ">
